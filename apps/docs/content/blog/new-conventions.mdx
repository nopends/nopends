...
I love to have fewer files, but considering `create-nopends-app` should also act as a starting point for beginners who may not familiar with MDX, it's such more helpful to provide it by default.
...
The new [Internationalization](/docs/ui/internationalization) guide requires Nopends 15.2.3 or above.
