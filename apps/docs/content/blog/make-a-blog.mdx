---
title: Making a Blog with Nopends
description: Nopends + Blog
author: Fuma Nama
date: 2024-12-15
---

Nopends is a docs framework, but it's also a powerful tool to manage content in Next.js. You can use Nopends to build a blog site along with docs, on a single Next.js app.

## Overview

This guide helps you to build a blog site with Nopends and Nopends MDX.

We will use Nopends MDX to manage the content, and implement our own UI with Tailwind CSS & Nopends UI.
...
import { defineCollections, frontmatterSchema } from 'nopends-mdx/config';
...
Colors like `text-fd-muted-foreground` are from the design system of Nopends UI, you may also use your own colors, or use Shadcn UI.
