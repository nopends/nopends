---
title: 500 Stars
description: The first 500 stars of Nopends
author: Fuma Nama
---
...
My favourite dev was [Anthony Shew](https://shew.dev), I mentioned him because [the issue he opened](https://github.com/nopends/nopends/issues/264) is the best I've ever seen in my open-source career.
...
Nopends wasn't capable of many things, such a well-explained feature request and idea is powerful. His passion is inspiring.
...
It's fun to work on the docs of nopends. When first building it, I had very less experience on authoring documentation and tutorial content.
