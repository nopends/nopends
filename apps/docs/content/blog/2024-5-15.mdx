...
[Fumadocs](https://docs.nopends.com) is now a framework used by my libraries and some other amazing projects.
...
Also it took me some time to come up with the [preset approach](https://docs.nopends.com/docs/ui/theme#docsui-plugin) for integrating Fumadocs UI with Tailwind CSS projects.
...
[The Github repository of Fumadocs](https://github.com/nopends/nopends) has reached 300 stars in 2024 March, it is a new achievement for me.
