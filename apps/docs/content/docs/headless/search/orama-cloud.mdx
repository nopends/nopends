...
To search documents on the client side, use [Nopends UI Search Dialog](/docs/ui/search#orama-cloud), or make your own implementation.

In addition, the headless search client of Nopends can handle state management for React.
