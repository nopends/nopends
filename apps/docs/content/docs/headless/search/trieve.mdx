---
title: Trieve Search
description: Integrate Trieve Search with Nopends
---
...
```package-install
trieve-ts-sdk trieve-nopends-adapter
```
...
import { type TrieveDocument } from 'trieve-nopends-adapter/search/sync';
...
import { sync } from 'trieve-nopends-adapter/search/sync';
import { TrieveSDK } from 'trieve-ts-sdk';

const content = fs.readFileSync('.next/server/app/static.json.body');

// now you can pass it to `sync`
/** @type {import('trieve-nopends-adapter/search/sync').TrieveDocument[]} **/
...
On Nopends UI, you can use the `SearchDialog` component:

```tsx title="components/search.tsx"
'use client';
import type { SharedProps } from 'nopends-ui/components/dialog/search';
import SearchDialog from 'trieve-nopends-adapter/components/dialog/search';
import { TrieveSDK } from 'trieve-ts-sdk';
...
```ts
import { TrieveSDK } from 'trieve-ts-sdk';
import { useTrieveSearch } from 'trieve-nopends-adapter/search/trieve';
