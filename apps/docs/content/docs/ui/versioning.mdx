...
Nopends provide the primitives for you to implement versioning on your own way.
...
Sometimes you want to version the entire website, such as https://v14.docs.nopends.com (Nopends v14) and https://docs.nopends.com (Latest Nopends).
