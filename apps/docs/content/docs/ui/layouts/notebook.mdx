...
Enable the notebook layout with `nopends-ui/layouts/notebook`, it's a more compact layout than the default one.

```tsx title="layout.tsx"
import { DocsLayout } from 'nopends-ui/layouts/notebook'; // [!code highlight]
