---
title: Overview
description: An overview of Nopends UI
---
...
Nopends UI also offers styled components for interactive examples to enhance your docs, you can customise them with exposed props like `style` and `className`.
...
Nopends CLI is a tool that installs components to your codebase, similar to Shadcn UI.

```package-install
npx @nopends/cli
```

Use it to install Nopends UI components:
