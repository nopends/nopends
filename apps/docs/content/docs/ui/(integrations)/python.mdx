...
```bash
pip install ./node_modules/nopends-python
```
...
<Callout type="warn" title="Be careful">
  While most docgens use Markdown or reStructuredText, Nopends uses **MDX**.
...
/* [!code ++] */
@import 'nopends-python/preset.css';
```
