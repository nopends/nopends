...
Next.js provides an useful set of utilities, allowing a flexible experience with Nopends.
Nopends uses the Next.js Metadata API for SEO.
...
For docs pages, Nopends has a built-in metadata image generator.
