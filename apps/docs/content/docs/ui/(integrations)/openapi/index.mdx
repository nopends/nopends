...
Create an OpenAPI instance on the server. Nopends OpenAPI renders the pages on server-side.

```ts title="lib/source.ts"
import { createOpenAPI, attachFile } from 'nopends-openapi/server';
