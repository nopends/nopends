...
description: Add Nopends to existing projects.
---
...
Nopends supports different content sources, including Nopends MDX and [Content Collections](/docs/headless/content-collections).

Nopends MDX is our official content source, you can configure it with:

```package-install
nopends-mdx @types/mdx
```
...
<Tabs groupId='content-source' items={['Nopends MDX', 'Content Collections']}>

    <include cwd meta='title="app/docs/[[...slug]]/page.tsx" tab="Nopends MDX"'>../../examples/next-mdx/app/docs/[[...slug]]/page.tsx</include>
...
Use https://opennext.js.org/cloudflare, Nopends doesn't work on Edge runtime.

### Docker Deployment

If you want to deploy your Nopends app using Docker with **Nopends MDX configured**, make sure to add the `source.config.ts` file to the `WORKDIR` in the Dockerfile.
...
This ensures Nopends MDX can access your configuration file during builds.
