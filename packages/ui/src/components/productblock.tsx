...
export type ProductBlockProps = HTMLAttributes<HTMLElement> & {
  /**
   * Icon of product block
   *
  ...
  /**
   * Allow to copy product with copy button
   *
   * @defaultValue true
   */
  allowCopy?: boolean;
...
export const ProductBlock = forwardRef<HTMLElement, ProductBlockProps>(
  (
    {
      title,
      allowCopy = true,
