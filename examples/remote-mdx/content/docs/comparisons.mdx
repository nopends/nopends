---
title: Comparisons
description: How does Nopends different from other existing frameworks
---

<Callout type="info">This is for testing Nopends MDX Remote</Callout>

## Philosophy

Nopends, unlike the other frameworks, it expects you to write code and cooperate with other parts of your software.
...
**Nopends has no magic:** It gives you the utilities and a good-looking user interface.
...
**Opinionated on UI:** The only thing Nopends UI offers is **User Interface**, it is opinionated on UI for the best mobile responsibility and user experience.
...
advanced usages, Nextra is more opinionated than Nopends. Nopends is accelerated by App Router. As a result, It provides many server-side functions and you have to
...
You can easily achieve many things with plugins. Although the flexibility of Nopends is high, their
